...
export default function game(navigation){
    ...
    const stop = () =>{
        setResult(Math.floor(Math.random()*(10 - (0))))
        setOponente("Sua pontuação final foi de: ")
        setPlayer("")
        setEscrita(pontos)
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <Text style={styles.textoDecoracao}>Ultima pontuação {lastResult}</Text>
            ...
            <View style={styles.organizacao}>
                ...
                <TouchableOpacity style={styles.gameButton} onPress={stop}>
